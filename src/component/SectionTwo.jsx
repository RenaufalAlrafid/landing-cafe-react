    ...
    <div className='flex' >
        ...
        <div className='flex justify-center items-center w-1/2'>
            <div className='text-center'>
                ...
                <a href="/#menu" className='py-4 px-5 border-solid border-2 rounded-xl border-primary-60 hover:bg-primary-60 hover:text-white text-secondary-60 '>Check Our Menu</a>
            </div>
        </div>
    </div>
  )
