...
export default function SectionThree() {
  return (
    <div>
        <div className='absolute z-0 w-[600px] h-[600px] bg-primary-20 -left-80 rounded-tr-full rounded-br-full bg-opacity-20 '></div>
        <div className='flex gap-20 '>
            <div className='text-end w-1/2 py-40 pl-20'>
                ...
                <div className='flex justify-end pt-9 gap-5'>
                    <a href="/" className='px-5 py-4 border-2 border-solid rounded-xl border-secondary-50 hover:bg-secondary-50 hover:text-white '> Our Location</a>
                    <a href="/" className='px-5 py-4  rounded-xl bg-secondary-50 text-white flex gap-3 hover:border-2 hover:border-solid hover:border-secondary-50 hover:bg-transparent hover:text-black'>
