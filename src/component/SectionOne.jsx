...
export default function SectionOne() {
  return (
    <div className='flex' id='home'>
        <div className='pr-16 pl-14 pb-16 mt-12'>
            ...
            <a href="/#form" className='bg-secondary-50 px-5 py-4 text-white rounded-xl hover:bg-primary-30 shadow-xl mt-5'> Join Membership</a>
        </div>
